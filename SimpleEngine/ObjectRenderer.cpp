...
void ObjectRenderer::createObjectRenderer(MeshType modelType, 
										glm::vec3 _position, 
										glm::vec3 _scale) {
	...
	gPipeline.createGraphicsPipelineAndLayout(swapChainImageExtent, 
...
void ObjectRenderer::draw() {
	...
	vkCmdBindDescriptorSets(cBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, 
			gPipeline.pipelineLayout, 0, 1, &descriptor.descriptorSet, 0, nullptr);
